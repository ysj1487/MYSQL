...
INSERT INTO `shopdb`.`producttbl` (`productname`, `cost`, `makedate`, `company`, `amount`) VALUES ('컴퓨터', '10', '2018-01-01', '삼성', '17');
INSERT INTO `shopdb`.`producttbl` (`productname`, `cost`, `makedate`, `company`, `amount`) VALUES ('세탁기', '20', '2018-09-01', 'LG', '3');
INSERT INTO `shopdb`.`producttbl` (`productname`, `cost`, `makedate`, `company`, `amount`) VALUES ('냉장고', '5', '2019-03-01', '대우', '23');
  
  CREATE TABLE `shopdb`.`membertbl` (
  `memberid` CHAR(5) NOT NULL,
  `membername` CHAR(5) NOT NULL,
  `memberaddreess` char(10) NOT NULL,
  PRIMARY KEY (`memberid`));

INSERT INTO `shopdb`.`membertbl` (`memberid`, `membername`, `memberaddreess`) VALUES ('dang', '당랑이', '경기 부천시');
INSERT INTO `shopdb`.`membertbl` (`memberid`, `membername`, `memberaddreess`) VALUES ('han', '한국한', '인천 남구');
INSERT INTO `shopdb`.`membertbl` (`memberid`, `membername`, `memberaddreess`) VALUES ('Jee', '지운이', '서울시 은평구');
INSERT INTO `shopdb`.`membertbl` (`memberid`, `membername`, `memberaddreess`) VALUES ('sang', '상길이', '경기도 성남시');
